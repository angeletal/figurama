...
<%    FiguraDAO fdao = new FiguraDAO();
    request.setAttribute("precioMinimo", fdao.getPrecioMinimo());
    request.setAttribute("precioMaximo", fdao.getPrecioMaximo());
%>
                                ...
                                <section class="facet__block">
                                    ...
                                    <div class="price-range-container ms-3">
                                        <p style="color:#ff6133" class="mb-1">
                                            De 
                                            <input type="number" style="margin-left:4px"  id="precio-minimo" value="${precioMinimo}" min="${precioMinimo}" step="0.01" onchange="validarPrecioMin()"> €
                                            <br><span class="ms-2">(Mínimo: <span id="labelMinimo">${precioMinimo}</span>€)</span>
                                        </p>
                                        <p style="color:#ff6133">
                                            &nbsp;a&nbsp;
                                            <input style="margin-left:6px"value="${precioMaximo}" type="number" id="precio-maximo" max="${precioMaximo}" step="0.01" onchange="validarPrecioMax()"> €
                                ...
                                <div class="sort_container">
                                    <div class="sort-by-row">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.ordenI eq 'recientes'}">
                                                    <select class="custom-select ml-sm-2 order ms-2" id="select-orden">
                                                        <option value="relevancias">Relevancia</option>
                                                        <option value="ofertas">Ofertas primero</option>
                                                        <option value="recientes" selected="selected">Más recientes</option>
                                                        <option value="antiguo">Más antigüos</option>
                                                 ...
                                                 <c:when test="${sessionScope.ordenI eq 'ofertas'}">
                                                    <select class="custom-select ml-sm-2 order ms-2" id="select-orden">
                                                        <option value="relevancias">Relevancia</option>
                                                        <option value="ofertas" selected="selected">Ofertas primero</option>
                                            ...
                                            <%
                                            request.getSession().removeAttribute("ordenI");
                                            %>
