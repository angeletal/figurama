...
public class ActualizarCesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cantidad >= 1) {
            ...
            //Si ya tiene cesta, que se cargue (o ha iniciado sesión o en anónimo ha añadido algo antes)
            ...
            switch (accion) {
                case "anadir": {
                    ...
                    ArticuloCesta articulo = new ArticuloCesta(fdao.getFiguraPorId(id));
                ...
                case "modificar": {
                    ...
                    for (int i = 0; i < cesta.getTamano(); i++) {
                        ...
                        if (articulo.equals(otro)) {
                            ...
                            //Si la cantidad de la BD es menor a la que se quiere establecer, devolvemos la cantidad nueva
                            if (otro.getFigura().getStock() >= cantidad) {
