 ...
 * @author Angel
 */
@WebServlet(name = "FiltroAdmin", urlPatterns = {"/admin"})
public class FiltroAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sesion.getAttribute("tablaMostrada") != null) {
            ...
            sesion.removeAttribute("tablaMostrada");
        }else{
            request.setAttribute("tablaMostrada", "Figura");
        }
