...
function generarDivPersonajes() {
    ...
    if (personajes.length === 0) {
        ...
        noPersonajesText.classList.add('text-center');
        noPersonajesText.textContent = 'No hay personajes registrados aún para esta franquicia';
...
// Crear el botón para ir a franquicias
        ...
        botonFranquicias.classList.add("btn-primary");
