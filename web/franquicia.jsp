<%-- 
    Document   : franquicia
    Created on : 7 jun 2023, 17:45:57
    Author     : Angel
--%>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarCollapse">
                        <ul class="navbar-nav ml-auto w-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../franquicias">Franquicias</a>
                            </li>
        ...
        <div class="content">
            ...
            <div class="text-center">
                <h1 class="mt-4">PERSONAJES DE <span id="nombreSerie"><c:out value="${serie}"/></span></h1>

                <div class="flex-container" id="contenedorPersonajes">


                </div>
            </div>

            <div id="contenedorFiguras"> 
        ...
        <script src="../assets/js/franquicia.js"></script>
