                ...
                <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-self-lg-stretch p-5 rounded rounded-lg-0 my-5 my-lg-0"  style="background-color: rgb(235, 216, 214)" 
                    ...
                    <div class="m-auto w-lg-75 w-xl-50">
                        ...
                        <form class="align-items-center">
                            ...
                            <div class="form-group mb-3"><label class="form-label">Nombre</label><input class="form-control" type="text" ></div>
                            <div class="form-group mb-3"><label class="form-label">Apellidos</label><input class="form-control" type="text" ></div>
                            <div class="form-group mb-3"><label class="form-label">Teléfono</label><input class="form-control" type="text" ></div>
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a class="btn btn-primary mt-2 p-2" type="submit" href="index.jsp">Registrarse</a>
                                <a class="btn btn-primary mt-2 p-2" type="submit" href="login.jsp">¿Ya tienes una cuenta? Acceder</a>
